...
// can`t load the correct library, directly added the functions.
...
void initializeTextures (Texture2D textures[]) {
  textures[FAZENDEIRO_INDEX] = LoadTexture(".dawd/fazendeiro.png");
  textures[COGUMELO_INDEX] = LoadTexture("./Others/cogumelo.png");
}
